...
describe('Page: /remaining-costs', () => {
  ...
  it('user selects eligible option: \'Yes\' -> store user response and redirect to /products-processed', async () => {
    const postOptions = {
      method: 'POST',
      url: `${global.__URLPREFIX__}/remaining-costs`,
      headers: { cookie: 'crumb=' + crumbToken },
    ...
    expect(postResponse.headers.location).toBe('products-processed')
  })
})
